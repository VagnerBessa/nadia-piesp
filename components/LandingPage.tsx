        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col w-full gap-3 pt-2">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 w-full px-6 py-3.5 rounded-2xl bg-white/[0.03] hover:bg-sky-500/10 active:scale-95 border border-white/5 hover:border-sky-500/30 text-slate-300 transition-all duration-300 focus:outline-none text-base font-medium"
            >
