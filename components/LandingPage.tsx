...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToVoice, onNavigateToChat }) => {
  ...
  return (
    <div className="relative flex flex-col w-full h-full min-h-0 overflow-y-auto px-5 py-4 md:py-10">
      ...
      <div className="flex-shrink-0 w-full max-w-sm mx-auto bg-slate-900/60 backdrop-blur-2xl rounded-[2rem] border border-white/5 p-5 mb-2 shadow-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-semibold">
              Empreendedorismo · Empresas em SP
            </p>
          </div>
          ...
          <div className="flex flex-col w-full gap-3 pt-2">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 w-full px-6 py-3.5 rounded-2xl bg-white/[0.03] hover:bg-orange-500/10 active:scale-95 border border-white/5 hover:border-orange-400/30 text-slate-300 transition-all duration-300 focus:outline-none text-base font-medium"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#E07A2F] group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
